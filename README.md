...
Date un gustito rapidito nomás con FoodMap
Encuentra el establecimiento más cercano de comida.

#### Flujo de la aplicación.

Vista splash con duración de 2 segundos que redirecciona a tu vista
principal.
![Splash](src/view/img/Appresponsive.png)
...
![vista principal](src/view/img/Appresponsive.png)
